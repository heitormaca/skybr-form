    ...
    <Container py="md">
      <Stack align="center">
        ...
        >
          ...
          <List.Item>
            Evite usar o chat do clã ou o TS3 para desabafos pessoais delicados.
            Cuide do ambiente coletivo.
          </List.Item>
        </List>
        <Title order={3} w="100%">
        ...
        >
          ...
          <List.Item>
            Evite PKs acidentais entre membros. Ajuste seus filtros corretamente
        ...
        >
          ...
          <List.Item>
            ...
            durante TWs, GvGs e eventos. Se estiver online mas não puder falar,
            permaneça em salas AFK ou informe a Staff.
          </List.Item>
        </List>
        <Title order={3} w="100%">
          🎁 Drops e Eventos
        ...
        >
          <List.Item>
            Use os canais corretos no TS3 para não atrapalhar outras atividades;
          </List.Item>
          <List.Item>
